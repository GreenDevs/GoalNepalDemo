 ...
 */
public class LatestParallexFragment extends Fragment
{
    ...
    private LatestParallexAdapter newsAdapter;
    private LinearLayoutManager mManager;
    private boolean loading = true;

    private CircularProgressView progressView;

    public LatestParallexFragment()
    {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        newsAdapter = new LatestParallexAdapter(newsData,context);
