 ...
 */
public class LatestDemoFragment extends Fragment
{
    ...
    *
    ...
    private LatestNewParallexAdapter latestNewsAdapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        latestNewsAdapter = new LatestNewParallexAdapter(newsData,context);
