 ...
 */
public class LatestParallexAdapter extends ParallaxRecyclerAdapter
{
    ...
    public LatestParallexAdapter(List<NewsSingleRow> data, Context context)
    {
        super(data);
    ...
    public void onBindViewHolderImpl(final RecyclerView.ViewHolder viewHolder, ParallaxRecyclerAdapter parallaxRecyclerAdapter, int i)
    {
        ...
        ((MyViewHolder)viewHolder).details.setText(data.get(i).title);//data.get(i).title);
